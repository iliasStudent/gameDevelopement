...
namespace Logic.AnimationEngine
{
    public class SnakeAnimations
    {
        ...
        public static Animation GetAttack1AnimatieFromSnake(ContentManager content)
        {
            Texture2D texture = content.Load<Texture2D>("Monsters/Cobra/cobraAttack");
        ...
        public static Animation GetAttack2AnimatieFromSnake(ContentManager content)
        {
            Texture2D texture = content.Load<Texture2D>("Monsters/Cobra/cobraAttack");
        ...
        public static Animation GetAttack3AnimatieFromSnake(ContentManager content)
        {
            Texture2D texture = content.Load<Texture2D>("Monsters/Cobra/cobraAttack");
